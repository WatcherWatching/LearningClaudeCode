---
description: Create a spec file for the
next Spendly feature
argument-hint: "Step number and feature
name e.g. 2 registration"
allowed-tools: Read, Write, Glob
---

You are a senior developer planning a new
feature for the
Spendly expense tracker. Always follow the
rules in CLAUDE.md.
...
Generate a spec document with this exact
structure:
...
does and whyit exists at this stage of the Spendly
roadmap.
...
- Modify: list existing templates and what
changes
...
## New dependencies
Any new pip packages. If none: state "No
new dependencies".
...
must be
something that can be verified by running
the app.
...
Do not print the full spec in chat unless
explicitly asked.